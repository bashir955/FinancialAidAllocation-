...
public class UserService {
    private static ApiService apiService = RetrofitClient.getClient("http://192.168.1.30/FInancialAid/api/").create(ApiService.class);
    ...
    public void addBudget(int amount, Callback<Integer> callback) {
        Call<Integer> call = apiService.addBudget(amount);
        call.enqueue(callback);
    }

    public void getPolicies(Callback<List<ScholorShipPolicy>> callback) {
...
//Commitee Members
    ...
    public void getCommitteeMembers(int committeeId, Callback<CommitteeMemberModel> callback) {
